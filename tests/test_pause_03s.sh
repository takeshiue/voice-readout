#!/bin/bash
# Test with 0.3s natural breath pause between filler and body
set -u
...
# Using punctuation and spacing to create a natural 0.3s breath pause
TEXT="お待たせしました。……安曇野の空は、抜けるように青く澄み渡っていました。"

echo "Playing Sample with 0.3s Natural Breath Pause:"
echo "Text: $TEXT"
